...
const (
	pj64UnknownRDRAM = "8388608"
	pj64ViRefresh    = "1500"
	pj64SkipPlugin   = "skip project64: video plugin missing (need Parallel-RDP or Angrylion, not Jabo)"
	pj64SkipInit     = "skip project64: video plugin failed to init"
)
