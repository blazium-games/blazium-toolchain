...
// Platform is one console family. PS1, PS2, and N64 are implemented; others return ErrPlanned.
...
type BuildOptions struct {
	...
	PackDir string // optional export dir with PACK/NODE/MESH/NTEX %02d extras
